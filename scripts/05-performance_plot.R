...
pdf("05-performance_plot.pdf",width=6,height=4)
  ...
  mtext(side=2,text='computation time (s)',line=1.5,las=3,cex=1.3)
  ...
  legend(x='topright',legend=c('Dissimilarity','Adjacency','S+ (Dw-Db comparisons)','HPE (pre-calculated D)','HPB (r=30,q=100)'),
